defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "with valida data inserts user" do
    ...
    test "requires password to be at least 6 chars long" do
      attrs = Map.put(@valid_attrs, :password, "aaa")
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns unauthorized error with invalid passowrd", %{user: user} do
      assert {:error, :unauthorized} = Accounts.authenticate_by_username_and_pass(user.username, 'Hodor')
    end
